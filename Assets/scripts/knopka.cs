...
public class knopka : MonoBehaviour
{
    ...
    public byte[] misbul;
    public byte qism=0,kun=0,oykun=0,ballnum=1,kun1=0,kun2=0;
    ...
    public void pp(){
        Application.OpenURL("https://docs.google.com/document/d/1I3ZWHE_Y1EAqseDS7ge3W8V2KICKZPmiaHI57pJ4zNQ/edit?usp=sharing");
    }
    public void pp1(){
        Application.OpenURL("https://docs.google.com/document/d/1K7RSzZ-QbZuRe7voDIuUeMwQzzbY6KR71wr6MLUSYKk/edit?usp=sharing");
    }
    public void pp2(){
        Application.OpenURL("https://sites.google.com/view/smartstream-technologies-iberi/support-form");
    }
    ...
    void Update()
    {
        ...
        if (Input.GetAxis("Mouse ScrollWheel") != 0f)
		{
			if (Input.GetAxis("Mouse ScrollWheel") > 0f)
			{
                ...
                if(ydelta<1920*3-1450){
                    tezlik=10;
                }else{tezlik=0;}
            }
        }else{
            if(ydelta<=1920/2||ydelta>=1920*3-1450){tezlik=0;}
            bbbb();
        }
        ydelta+=(short)tezlik;
    ...
    public void taxtatalla(){
        /*switch(ballnum){
            case 0:materialkaltak.SetColor("_EmissionColor", c1);break;
            case 1:materialkaltak.SetColor("_EmissionColor", c2);break;
            case 2:materialkaltak.SetColor("_EmissionColor", c3);break;
        }*/
    }
    byte timerkun(){
        byte qu=0;
